    ...
    <div class="page-inner">
        <div class="page-header">
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                <div>
                    <h3 class="fw-bold mb-3">Update Coupon</h3>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <form class="card" id="created_category_form" action="{{route('coupon.update', $coupon->id)}}"
                    method="post">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="startedDate" name="startedDate"
                                        ...
                                        value="{{old('startedDate') ?? $coupon->startedDate}}" />
                                    @error('startedDate ')
                                        <span class="text-danger"> {{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="endedDate" name="endedDate"
                                        ...
                                        value="{{old('endedDate') ?? $coupon->endedDate}}" />
                                    @error('endedDate ')
                                        <span class="text-danger"> {{ $message }}</span>
                                    @enderror
                                </div>
