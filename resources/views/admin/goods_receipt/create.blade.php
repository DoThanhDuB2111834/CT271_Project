    ...
    <div class="page-inner">
        <div class="page-header">
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                <div>
                    <h3 class="fw-bold mb-3">Create goods_receipt</h3>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <form id="created_category_form" action="{{route('goods_receipt.store')}}" method="post">
                    @csrf
                    <div class="card">
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="Category_name" name="reason"
                                            placeholder="Enter reason name" value="{{old('reason') ?? ''}}" />
                                        @error('reason')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" id="exampleFormControlSelect1" name="supplier_id">
                                            ...
                                            @foreach ($suppliers as $item)
                                                <option value="{{$item->id}}" {{$item->id == old('supplier') ? 'selected' : ''}}>
                                                    {{$item->name}}
                                                </option>
                                            @endforeach
                                        </select>
                                                    ...
                                                    <tbody id="table_product_detail">
                                                        @foreach (old('product_infors') ?? [] as $item)
                                                            <tr role="row">
                                                                ...
                                                                <td field="total">
                                                                    {{formatedPrice($item->get('price') * $item->get('quantity'))}}
                                                                </td>
